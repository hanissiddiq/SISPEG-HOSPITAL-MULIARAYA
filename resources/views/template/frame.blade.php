...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ url('admin/assets') }}" data-template="{{ url('admin/html/vertical-menu-template') }}">
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ url('/Image/Logo-RS.png') }}" />
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
                    ...
                    <a href="{{ url('/dashboard') }}" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <span style="color: var(--bs-primary)">
                                ...
                                <img src="{{ url('/Image/Logo-Rs.png') }}" class="img-fluid" width="40px">
                            </span>
                        </span>
            ...
            <li class="menu-item {{$page == 'Transaksi'?'open':''}}">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{$sub == 'Transaksi Selesai'?'active':''}}">
                  <a href="{{url('/transaksi_selesai')}}" class="menu-link">
                    ...
                    <li class="menu-item {{ $page == 'Departmen' ? 'active' : '' }}">
                        <a href="{{ url('/departmen') }}" class="menu-link">
                            <i class="menu-icon tf-icons mdi mdi-hospital-building"></i>
                            <div data-i18n="Data Departmen">Data Departmen</div>
                        </a>
                    </li>
                    <li class="menu-item {{ $page == 'Cuti' ? 'active' : '' }}">
                        <a href="{{ url('/cuti') }}" class="menu-link">
                            <i class="menu-icon tf-icons mdi mdi-run-fast"></i>
                            <div data-i18n="Data Jenis Cuti">Data Jenis Cuti</div>
                        </a>
                    </li>
                    <li class="menu-item {{ $page == 'Status' ? 'active' : '' }}">
                        <a href="{{ url('/status') }}" class="menu-link">
                            <i class="menu-icon tf-icons mdi mdi-account-badge-outline"></i>
                            <div data-i18n="Data Status Pegawai">Data Status Pegawai</div>
                        </a>
                    </li>
                    {{-- //menu tab dropdown --}}
                    {{-- <li class="menu-item {{$page == 'Transaksi'?'open':''}}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons mdi mdi-swap-horizontal"></i>
                <div data-i18n="Data Departmen">Data Jenis Cuti</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item {{$sub == 'Transaksi Baru'?'active':''}}">
                  <a href="{{url('/transaksi_baru')}}" class="menu-link">
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <p class="fst-italic">SISPEGA MULIA RAYA</p>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <span class="fw-semibold d-block">Hanis Siddiq</span>
    ...
    {{-- script DataTable Responsive with modal --}}
    ...
    {{-- start fungsi toggle lihat password --}}
    <script>
    ...
    {{-- end fungsi toggle lihat password --}}
