...
<body class="index-page">
                    ...
                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Layanan</span> <i
                            ...
                            <ul>
                                ...
                                <li class="dropdown"><a href="#"><span>Dukungan Medis</span> <i
                                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                                    <ul>
                                ...
                                <li class="dropdown"><a href="#"><span>Prosedur</span> <i
                                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                                    <ul>
    ...
    <main class="main">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        ...
                        <p>Kami hadir memberikan pelayanan kesehatan terbaik dengan memprioritaskan kebutuhan pasien dan
                            keluarga. Dengan layanan kesehatan berbasis Value Based Care yang didukung teknologi,
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="fst-italic">
                            ...
                            Dengan tim medis yang berpengalaman dan fasilitas modern, kami berupaya memberikan layanan
                            terbaik untuk memenuhi kebutuhan kesehatan Anda.
            ...
            <div class="container">
                ...
                <div class="row justify-content-around gy-4">
                    <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <img src="{{ url('Homepage/assets/img/features.jpg') }}" alt="">
                    </div>
        ...
        <section id="tabs" class="tabs section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Departments</h2>
                <p>Di Rumah Sakit Mulia Raya, kami menghadirkan berbagai departemen medis dan penunjang yang lengkap,
                    didukung oleh tenaga profesional yang berpengalaman dan fasilitas modern. Berikut adalah
                    departemen-departemen utama yang kami miliki:</p>
            </div><!-- End Section Title -->
                            ...
                            <div class="tab-pane active show" id="tabs-tab-1">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>Departemen Kardiologi Rumah Sakit Mulia Raya menyediakan layanan pemeriksaan
                                            dan perawatan menyeluruh untuk penyakit jantung dan pembuluh darah. Didukung
                                            oleh dokter spesialis jantung berpengalaman dan teknologi diagnostik modern
                                            untuk memastikan penanganan cepat, akurat, dan aman bagi pasien dengan
                                            gangguan kardiovaskular.</p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        {{-- <img src="assets/img/departments-1.jpg" alt="" class="img-fluid"> --}}
                                        <img src="{{ url('Homepage/assets/img/departments-1.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-2">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        <h3>Neurology</h3>
                                        {{-- <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka</p> --}}
                                        <p>Departemen Neurologi kami menangani berbagai gangguan sistem saraf, seperti
                                            stroke, epilepsi, vertigo, dan neuropati. Dengan pendekatan medis yang
                                            holistik, pasien mendapatkan perawatan optimal melalui konsultasi spesialis,
                                            pemeriksaan penunjang, serta terapi rehabilitasi yang tepat sesuai kondisi
                                            neurologis masing-masing.</p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        {{-- <img src="assets/img/departments-2.jpg" alt="" class="img-fluid"> --}}
                                        <img src="{{ url('Homepage/assets/img/departments-2.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-3">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>Kami melayani diagnosis dan pengobatan penyakit hati seperti hepatitis,
                                            sirosis, dan gangguan fungsi hati lainnya. Dengan tenaga ahli di bidang
                                            hepatologi dan dukungan fasilitas laboratorium lengkap, kami berkomitmen
                                            memberikan terapi efektif demi meningkatkan kualitas hidup pasien.</p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ url('Homepage/assets/img/departments-3.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-4">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>Departemen Pediatri fokus pada perawatan kesehatan anak secara menyeluruh,
                                            mulai dari bayi hingga remaja. Layanan meliputi imunisasi, konsultasi tumbuh
                                            kembang, serta penanganan penyakit umum dan kronis anak oleh dokter
                                            spesialis anak yang ramah dan profesional.</p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ url('Homepage/assets/img/departments-4.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-5">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>Layanan spesialis mata RS Mulia Raya mencakup pemeriksaan, diagnosis, dan
                                            penanganan berbagai gangguan penglihatan seperti katarak, glaukoma, infeksi
                                            mata, hingga gangguan refraksi. Kami menggunakan peralatan optik modern dan
                                            memberikan perawatan yang aman serta nyaman bagi semua usia.</p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ url('Homepage/assets/img/departments-5.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
        ...
        <section id="testimonials" class="testimonials section">
            ...
            <p>
              <i class=" bi bi-quote quote-icon-left"></i>
                <span>Pelayanan di Rumah Sakit Mulia Raya sangat memuaskan. Dokternya ramah dan perawatnya cekatan. Saya merasa tenang saat anak saya dirawat di sini."
                                </span>
                                <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                                <img src="{{ url('Homepage/assets/img/testimonials/testimonials-1.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>Saya dirawat selama tiga hari di RS Mulia Raya dan sangat puas dengan
                                        kebersihan kamar serta respons cepat dari tenaga medis. Sangat
                                        direkomendasikan!</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                                {{-- <img src="assets/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt=""> --}}
                                <img src="{{ url('Homepage/assets/img/testimonials/testimonials-2.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>Dari pendaftaran hingga konsultasi, semua proses berjalan lancar dan cepat.
                                        Fasilitasnya juga lengkap dan modern. Sangat profesional!</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                                {{-- <img src="assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt=""> --}}
                                <img src="{{ url('Homepage/assets/img/testimonials/testimonials-3.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>Rumah sakit ini punya dokter spesialis yang sangat kompeten. Saya merasa lebih
                                        sehat setelah menjalani perawatan jantung di sini.</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                                <img src="{{ url('Homepage/assets/img/testimonials/testimonials-4.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>Istri saya melahirkan anak kedua di RS Mulia Raya. Pengalaman yang luar biasa!
                                        Tim medis sangat perhatian dan sigap dalam membantu proses persalinan.</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                                <img src="{{ url('Homepage/assets/img/testimonials/testimonials-5.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ url('Homepage/assets/img/doctors/doctors-1.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ url('Homepage/assets/img/doctors/doctors-2.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ url('Homepage/assets/img/doctors/doctors-3.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ url('Homepage/assets/img/doctors/doctors-4.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                  ...
                  "spaceBetween": 20
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-1.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-1.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-2.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-2.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-3.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-3.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-4.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-4.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-5.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-5.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-6.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-6.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-7.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-7.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                        <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                href="{{ url('Homepage/assets/img/gallery/gallery-8.jpg') }}"><img
                                    src="{{ url('Homepage/assets/img/gallery/gallery-8.jpg') }}" class="img-fluid"
                                    alt=""></a></div>
                    </div>
                    <div class="swiper-pagination"></div>
                </div>
                        ...
                        <div class="faq-container">
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Rumah Sakit Mulia Raya menyediakan layanan unggulan seperti IGD 24 jam, rawat
                                        inap, rawat jalan, persalinan, laboratorium, radiologi, dan layanan spesialis
                                        seperti jantung, anak, penyakit dalam, serta bedah.</p>
                                </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Ya, RS Mulia Raya bekerja sama dengan BPJS Kesehatan dan melayani pasien peserta
                                        JKN-KIS dengan prosedur yang sesuai ketentuan.</p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Pendaftaran bisa dilakukan langsung di loket pendaftaran RS atau melalui sistem
                                        online (jika tersedia) dengan mengisi data pasien dan memilih jadwal dokter.</p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Ya, IGD RS Mulia Raya siap melayani pasien gawat darurat selama 24 jam dengan
                                        tenaga medis profesional dan fasilitas lengkap.</p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Tentu. Rumah Sakit Mulia Raya memiliki dokter spesialis di berbagai bidang
                                        seperti penyakit dalam, anak, kandungan, bedah umum, ortopedi, dan lainnya.</p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>RS Mulia Raya menerima pembayaran tunai, debit, kartu kredit, asuransi swasta,
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Ya, tersedia berbagai pilihan kelas kamar rawat inap mulai dari kelas 3 hingga
                                        VIP dengan fasilitas yang nyaman dan bersih.</p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div><!-- End Faq item-->
        ...
        <section id="contact" class="contact section">
            ...
            <div class="mb-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <iframe style="border:0; width: 100%; height: 370px;"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3975.2386834406548!2d97.8221887740377!3d4.8996692399025195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3037f98342c7d815%3A0x6bc0b79e52d7c3c7!2sRS%20MULIA%20RAYA!5e0!3m2!1sen!2sid!4v1744514740571!5m2!1sen!2sid"
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-md-3 footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('create_user') }}">SISPEGA</a></li>
                    </ul>
                </div>
