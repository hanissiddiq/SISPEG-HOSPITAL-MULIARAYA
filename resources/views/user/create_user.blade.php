                    ...
                    <tbody>
                        @foreach ($users as $data)
                            ...
                            <tr>
                                ...
                                <td>{{ $data->telp }}</td>
                                <td>
                                    {{-- <img src="{{ $data->foto }}" width="40px" alt=""> --}}
                                    <img src="{{ asset('uploads/' . $user->foto) }}" alt="Foto" width="100">
                                    {{-- {{ $data->foto }} --}}
                                </td>
                                <td>{{ $data->alamat }}</td>
                                <td>{{ $data->status_pegawai }}</td>
                                {{-- <td>{{ $data->tgl_masuk }}</td> --}}
                                <td>{{ \Carbon\Carbon::parse($data->tgl_masuk)->translatedFormat('d M Y') }}</td>

                                <td {{ $hidden_class }} class="text-center">
                                    <div class="w-100 {{ $tampil_class }}">{{ $tampil_role }}</div>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store_user') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            <label class="font-weight-bold">Password</label>
                            <input type="text" name="password" class="form-control" placeholder="Password" maxlength="15"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea name="alamat" class="form-control" placeholder="Alamat" maxlength="200">{{ old('alamat') }}</textarea>
                            {{-- 
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    {{-- <button type="submit" class="btn btn-primary">Simpan</button> --}}
                    <button type="submit" data-bs-toggle="modal" data-bs-target="#modalCreateUser">
                        Tambah User
                    </button>
                </div>
                </form>
